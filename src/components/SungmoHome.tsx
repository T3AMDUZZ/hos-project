      ...
      <section className="shortcut">
        <div className="container">
          ...
          <ul>
            ...
            <li><Link href="/guide/equipment"><span className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" /><path d="M8 21h8M12 17v4" /><path d="M6 10l3 2 2-4 2 5 2-3" /></svg></span><b>검사장비 소개</b></Link></li>
            <li><Link href="/guide/costs"><span className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2" /><circle cx="12" cy="12" r="2.5" /><path d="M6 12h.01M18 12h.01" /></svg></span><b>검사비용 안내</b></Link></li>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="qlink">
            ...
            <Link href="/guide/costs"><span className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2" /><circle cx="12" cy="12" r="2.5" /><path d="M6 12h.01M18 12h.01" /></svg></span><em>검사비용</em></Link>
            <Link href="/guide/equipment"><span className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" /><path d="M8 21h8M12 17v4" /><path d="M6 10l3 2 2-4 2 5 2-3" /></svg></span><em>검사장비</em></Link>
